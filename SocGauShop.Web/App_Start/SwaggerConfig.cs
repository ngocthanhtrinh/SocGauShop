...
namespace SocGauShop.Web
{
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "SocGauShop.Web");
    ...
    public class IgnoreHttpRequestMessageOperationFilter : IOperationFilter
    {
        ...
        {
            apiDescription.ParameterDescriptions.Where(desc => desc.ParameterDescriptor.ParameterType
